...
this.ALL_MISSION_CLEAR={
  heroicPoint=10000,
  ogrePoint=0
}

this.ALL_MISSION_S_RANK_CLEAR={
  heroicPoint=50000,
  ogrePoint=0
}

this.QUEST_CLEAR={
  [TppDefine.QUEST_RANK.S]={
    heroicPoint=500,
    ogrePoint=0
  },
  [TppDefine.QUEST_RANK.A]={
    heroicPoint=400,
    ogrePoint=0
  },
  [TppDefine.QUEST_RANK.B]={
    heroicPoint=400,
    ogrePoint=0
  },
  [TppDefine.QUEST_RANK.C]={
    heroicPoint=300,
    ogrePoint=0
  },
  [TppDefine.QUEST_RANK.D]={
    heroicPoint=300,
    ogrePoint=0
  },
  [TppDefine.QUEST_RANK.E]={
    heroicPoint=200,
    ogrePoint=0
  },
  [TppDefine.QUEST_RANK.F]={
    heroicPoint=200,
    ogrePoint=0
  },
  [TppDefine.QUEST_RANK.G]={
    heroicPoint=100,
    ogrePoint=0
  },
  [TppDefine.QUEST_RANK.H]={
    heroicPoint=100,
    ogrePoint=0
  },
  [TppDefine.QUEST_RANK.I]={
    heroicPoint=0,
    ogrePoint=0
  }
}

this.QUEST_ALL_CLEAR={
  heroicPoint=30000,
  ogrePoint=0
}
this.MINE_QUEST_ALL_CLEAR={
  heroicPoint=5000,
  ogrePoint=-5000
}
this.ENEMY_HOLD_UP={
...
this.ENEMY_INTERROGATE={
  heroicPoint=5,
  ogrePoint=0
}
this.PLAYER_ON_INJURY={
  heroicPoint=-10,
  ogrePoint=0
}
this.PLAYER_DEAD={
...
this.FULTON_PARASITE={
  heroicPoint=30,
  ogrePoint=-30
}
this.ON_HELI_DYING_ENEMY={
  heroicPoint=60,
  ogrePoint=-60
}
this.ON_HELI_HOSTAGE={
  heroicPoint=120,
  ogrePoint=-120
}
this.ON_HELI_LIQUID={
...
this.FIRE_KILL_SOLDIER={
  heroicPoint=0,
  ogrePoint=120
}
this.FIRE_KILL_SOLDIER_FOB_SNEAK={
...
this.FIRE_KILL_HOSTAGE={
  heroicPoint=-90,
  ogrePoint=200
}
this.FIRE_KILL_DD_HOSTAGE={
  heroicPoint=-90,
  ogrePoint=180
}
this.FIRE_KILL_DD_SOLDIER={
  heroicPoint=-90,
  ogrePoint=180
}
this.KILL_DD_SOLDIER={
  heroicPoint=-60,
  ogrePoint=180
}
this.KILL_DD_HOSTAGE={
  heroicPoint=-60,
  ogrePoint=90
}
this.DEAD_HOSTAGE={
...
this.BREAK_GIMMICK_BY_TYPE={
  [TppGimmick.GIMMICK_TYPE.ANTN]={
    heroicPoint=0,
    ogrePoint=0
  },
  [TppGimmick.GIMMICK_TYPE.MCHN]={
    heroicPoint=0,
    ogrePoint=0
  },
  [TppGimmick.GIMMICK_TYPE.CMMN]={
    heroicPoint=0,
    ogrePoint=0
  },
  [TppGimmick.GIMMICK_TYPE.GNRT]={
    heroicPoint=0,
    ogrePoint=0
  },
  [TppGimmick.GIMMICK_TYPE.SWTC]={
    heroicPoint=0,
    ogrePoint=0
  },
  [TppGimmick.GIMMICK_TYPE.AACR]={
    heroicPoint=0,
    ogrePoint=0
  }
}

this.SUPPORT_HELI_LOST_CONTROLE={
  heroicPoint=-60,
  ogrePoint=150
}
this.BREAK_SUPPORT_HELI={
  heroicPoint=-30,
  ogrePoint=0
}
this.ENEMY_HELI_LOST_CONTROLE={
  heroicPoint=0,
  ogrePoint=120
}
this.ON_ANNIHILATE_BASE={
  heroicPoint=300,
  ogrePoint=0
}
this.ON_ANNIHILATE_OUTER_BASE={
  heroicPoint=30,
  ogrePoint=0
}
this.CONSTRUCT_FIRST_FOB={
  heroicPoint=1000,
  ogrePoint=0
}
this.CONSTRUCT_SECOND_FOB={
  heroicPoint=2000,
  ogrePoint=0
}
this.CONSTRUCT_THIRD_FOB={
  heroicPoint=3000,
  ogrePoint=0
}
this.CONSTRUCT_FOURTH_FOB={
  heroicPoint=4000,
  ogrePoint=0
}
this.HORSE_RIDED={
...
this.BREAK_SECURITY_CAMERA={
  heroicPoint=0,
  ogrePoint=0
}
this.BREAK_SECURITY_UAV={
  heroicPoint=0,
  ogrePoint=0
}
this.DYING_PARASITE={
...
function this.AddTargetLifesavingHeroicPoint(isChild,recoveredByHeli)
  if recoveredByHeli then
    if isChild then
      TppMotherBaseManagement.AddTempLifesavingLog{
        heroicPoint=240,
        subOgrePoint=240
      }
    else
    ...
    if band(stateFlag,StateFlag.DYING_LIFE)~=0 then
      if recoveredByHeli then
        ...
        if((not TppMission.IsFOBMission(vars.missionCode))or TppServerManager.FobIsSneak())then
          ...
          this.SetAndAnnounceHeroicOgrePoint{
            heroicPoint="HEROIC_POINT_FULTONED_DYING_STAFF",
            ogrePoint="OGRE_POINT_FULTONED_DYING_STAFF"
          }
        end
      end
    else
...
--No refs?
function this.OnFultonEli(gameObjectId,recoveredByHeli)
  if recoveredByHeli then
    TppMotherBaseManagement.AddTempLifesavingLog{
      heroicPoint=240,
      subOgrePoint=240
...
function this.Messages()
  return Tpp.StrCode32Table{
    GameObject={
      ...
      {
        msg="Dead",
        func=function(gameId,attackerId,playerPhase,deadMessageFlag)
      ...
      {
        msg="BreakGimmick",
        func=this.AnnounceBreakGimmick
      },
      {
        msg="VehicleBroken",
      ...
      {
        msg="LostControl",
        func=function(gameId,state,attackerId)
          if state==StrCode32"Start"then
